  ...
  return (
    <section className="py-20">
      <div className="container max-w-3xl text-center">
        ...
        <h1 className="text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary to-pink-500">
          {siteConfig.description}
        </h1>
        <p className="text-muted-foreground text-lg mb-12 max-w-xl mx-auto">
          Transform cumbersome URLs into clean, shareable links in a snap.
