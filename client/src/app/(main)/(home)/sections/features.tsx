      ...
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Modern, minimal, and built for developers who need a reliable URL
            shortening solution
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-card rounded-xl border border-border p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-muted-foreground">
              Generate shortened URLs instantly with zero latency and minimal
              overhead.
            </p>
          ...
          <div className="bg-card rounded-xl border border-border p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-muted-foreground">
              Create branded short links with custom slugs, perfect for sharing
              and marketing.
            </p>
            <div className="mt-4 pt-4 border-t border-border">
          ...
          <div className="bg-card rounded-xl border border-border p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-muted-foreground">
              Track clicks, referrers, and user locations with our simple yet
              powerful analytics.
            </p>
            <div className="mt-4 pt-4 border-t border-border">
