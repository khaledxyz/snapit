    ...
    <div className="container max-w-3xl py-12">
      ...
      <div className="prose prose-sm max-w-none">
        <p className="text-muted-foreground">
          At SnapIt, we value your privacy and are committed to protecting your
          personal information. This Privacy Policy explains how we collect,
          use, and safeguard your data when you use our URL shortening service.
        </p>
        ...
        <div className="mt-8 space-y-12">
            ...
            <div className="bg-card border border-border rounded-lg p-6">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    To improve our service and understand user behavior, we
                  ...
                  <ul className="list-disc pl-5 mt-2 space-y-1 text-sm text-muted-foreground">
                    ...
                    <li>
                      Anonymized IP address information (we truncate IP
                      addresses)
                    </li>
                  ...
                  <div className="mt-3 text-xs flex items-center gap-1 bg-primary/10 text-primary p-2 rounded-md border border-primary/30">
                    <Eye size={12} />
                    <span>
                      We use a privacy-focused analytics solution that does not
                      use cookies for tracking visitors.
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-card border border-border rounded-lg p-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    To create and manage shortened URLs, redirect users, and
                ...
                <div className="bg-card border border-border rounded-lg p-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    To analyze usage patterns and improve our service design,
                ...
                <div className="bg-card border border-border rounded-lg p-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    To provide link creators with aggregated statistics about
                    the performance of their links.
                  </p>
                </div>
                ...
                <div className="bg-card border border-border rounded-lg p-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    ...
                    threats, fraud, or other harmful activity.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">
                        ...
                        We only collect the information necessary to provide and
                        improve our service.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">
                        ...
                        We never sell your personal information or URL data to
                        third parties.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">
                        ...
                        Our analytics implementation uses privacy-focused
                        technology that doesn&apos;t use cookies and minimizes
                        data collection.
                      </p>
                    </div>
                  </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              <p className="text-muted-foreground">
                We respect your privacy choices and provide several ways to
                control your data:
              </p>
              ...
              <div className="bg-card border border-border rounded-lg overflow-hidden">
                <div className="p-4 border-b border-border">
                  ...
                  <p className="text-muted-foreground text-sm mt-1">
                    You can opt out of analytics tracking by enabling your
                    browser&apos;s &quot;Do Not Track&quot; setting. We honor
                    DNT signals.
                  </p>
                </div>
                ...
                <div className="p-4 border-b border-border">
                  ...
                  <p className="text-muted-foreground text-sm mt-1">
                    If you create an account, you can delete any shortened URLs
                    you&apos;ve created through your dashboard.
                  </p>
                </div>
                ...
                <div className="p-4">
                  ...
                  <p className="text-muted-foreground text-sm mt-1">
                    ...
                    please contact us at privacy@snapit.io.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section>
            ...
            <p className="text-muted-foreground mt-2">
              ...
              any changes. Your continued use of our service after any
          ...
          <section>
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
              ...
              <p className="text-muted-foreground text-sm">
                SnapIt is an open-source project. Our code is publicly
                available, which means you can inspect exactly how we handle
                your data. We believe in transparency and giving users control
                over their privacy.
              </p>
              <div className="mt-4">
                <Link
