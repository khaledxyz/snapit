...
import { UrlResponse, useCreateShortUrl } from "@/api/urls"
                ...
                {shortenedUrls && shortenedUrls.length > 0 && (
                    <Fragment>
                        ...
                        {shortenedUrls.map((url) => {
                            const shortenedUrl = `${process.env.NEXT_PUBLIC_CLIENT_URL}/${url.shortCode}`
                            return (
                                <Alert className="flex items-center justify-between mb-1" key={url._id}>
                                    <AlertDescription>
