                        ...
                        <div className="bg-card border border-border rounded-lg p-6">
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="mt-3 text-xs flex items-center gap-1 bg-secondary/10 text-secondary p-2 rounded-md">
                                        <Eye size={12} />
                                ...
                                <div>
                                    <h3 className="font-medium mb-2">Link Click Data</h3>
                                    <p className="text-muted-foreground text-sm">
                                        When someone clicks on a shortened URL, we record:
                                    </p>
                                    <ul className="list-disc pl-5 mt-2 space-y-1 text-sm text-muted-foreground">
                                        <li>Timestamp of the click</li>
                                        <li>Referring website (if available)</li>
