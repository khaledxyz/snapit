...
const isAuthenticatedRoute = (path: string) => matchRoute(path, authenticatedRoutes)
const isPublicRoute = (path: string) => matchRoute(path, publicRoutes)
const isUnauthenticatedRoute = (path: string) => matchRoute(path, unauthenticatedRoutes)
