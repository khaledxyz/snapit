...
void main() {
  ...
  float uvY = gl_FragCoord.y / resolution.y;
  float fadeAmount = smoothstep(0.0, 0.4, uvY);
  
  vec3 col = waveColor * f;
  gl_FragColor = vec4(col, f * fadeAmount);
}
`;
...
class RetroEffectImpl extends Effect {
  private readonly colorNumUniform: Uniform;
  private readonly pixelSizeUniform: Uniform;
  ...
  constructor() {
    ...
    this.colorNumUniform = uniforms.get("colorNum") as Uniform;
    this.pixelSizeUniform = uniforms.get("pixelSize") as Uniform;
  }
